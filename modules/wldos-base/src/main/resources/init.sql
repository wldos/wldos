...
CREATE TABLE `k_pubs` (
                          ...
                          `pub_title` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标题',
                          `pub_excerpt` text COLLATE utf8mb4_unicode_ci COMMENT '摘要',
                          `pub_status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发布状态：publish已发表、draft草稿、private私密、static静态化、object对象化、inherit继承帖子(附件图片类)',
                          `comment_status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评论状态，open允许评论、closed禁止评论、user_only注册用户可评',
                          `pub_password` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '设置后修改发布需要输入密码',
                          `pub_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '别名，用于生成超链接',
                          `parent_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '上级帖子id，0表示没有上级，附件的上级是帖子，篇章的上级是文集',
                          `pub_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发布类型：页面page、post帖子、图片pic、视频video、音频voice、系列视频seriesvideo、系列音频seriesvoice、电子书book、附件attachment、篇章chapter、剧集series',
                          `domain_id` bigint(20) unsigned DEFAULT NULL COMMENT '域id，内容从哪个域创建的',
                          `com_id` bigint(20) unsigned DEFAULT NULL COMMENT '公司id(租户id)',
                          `pub_mime_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发布内容mime类型：图片image/xxx、音频audio/xxx、视频video/xxx、应用文件application/xxx、文本类text/xxx',
...
INSERT INTO `wo_file` VALUES ('313079890261491716', 'wldos.png', '/2023/07/291705327dwJtnPW.png', 'image/png', '1', '1', '2023-07-29 17:05:33', '127.0.0.1', '1', '2023-07-29 17:05:33', '127.0.0.1', 'normal', '0');
INSERT INTO `wo_file` VALUES ('313080073980395530', 'favicon.ico', '/2023/07/29170616scjFXdRn.ico', 'image/x-icon', '1', '1', '2023-07-29 17:06:16', '127.0.0.1', '1', '2023-07-29 17:06:16', '127.0.0.1', 'normal', '0');
...
-- Records of wo_user
-- ----------------------------
INSERT INTO `wo_user` VALUES ('1', 'admin', '龙神', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', 'normal', '0', null, 'admin', 'man', null, '15665730355', '0531-268888888', '注册会员', '网络用户', '长清区崮云湖街道', null, '30699@qq.com', '/2023/07/291705327dwJtnPW.png', 'WLDOS之父，独立研发了WLDOS云应用支撑平台。', '0', '0', 'China', '370000', '370100', null, '0', null, '192.168.1.23', '0', '2021-05-08 12:15:05', '192.168.1.23', '1', '2023-07-29 17:05:33', '127.0.0.1', 'normal', '1');
