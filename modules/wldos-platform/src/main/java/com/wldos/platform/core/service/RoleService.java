...
import com.wldos.platform.core.enums.RoleTypeEnum;
...
public class RoleService extends EntityService<RoleDao, WoRole, Long> {
	private final AuthRoleDao authRoleRepo;
