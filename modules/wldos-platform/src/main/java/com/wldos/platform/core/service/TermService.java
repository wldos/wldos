...
public class TermService extends EntityService<TermDao, KTerms, Long> implements TermOpener {
	...
	private final TermTypeDao termTypeRepo;

	private final TermObjectDao termObjectRepo;

	private final TermObjectService termObjectService;

	public TermService(TermTypeDao termTypeRepo, TermObjectDao termObjectRepo, TermObjectService termObjectService) {
