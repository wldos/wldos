...
public class CompanyService extends EntityService<CompanyDao, WoCompany, Long> {
	...
	public CompanyService(OrgDao orgRepo, OrgUserDao orgUserRepo, ComUserDao comUserRepo) {
