...
import com.wldos.system.sysenum.RoleTypeEnum;
...
import com.wldos.system.repo.AuthRoleRepo;
import com.wldos.system.repo.RoleRepo;
...
public class RoleService extends BaseService<RoleRepo, WoRole, Long> {
	...
	public List<WoRole> findAllTenant() {
		return this.entityRepo.findAllTenant(RoleTypeEnum.talRole.toString());
	}
}
