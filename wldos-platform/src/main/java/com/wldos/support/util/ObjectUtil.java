...
public final class ObjectUtil {
	...
	public static boolean existsBlank(Object ...obj) {
		...
		return Arrays.stream(obj).anyMatch(ObjectUtil::isBlank);
	}
	...
	public static String hidePhone(String phoneNum) {
		if (ObjectUtil.isBlank(phoneNum))
			return phoneNum;
	...
	public static String hideName(String fullName) {
		if (ObjectUtil.isBlank(fullName))
			return fullName;
