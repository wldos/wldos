...
import { getTicketDetail, replyTicket } from './service';
...
const TicketDetail = () => {
  ...
  return (
    <PageContainer
      title="工单详情"
      extra={
        <Button icon={<ArrowLeftOutlined />} onClick={() => history.push('/ticket/list')}>
          返回列表
        </Button>
      }
    >
