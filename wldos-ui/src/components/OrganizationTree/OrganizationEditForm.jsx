...
const OrganizationEditForm = ({ organization, onSubmit, loading }) => {
  ...
  return (
    <Form
      ...
      initialValues={{
        ...
        orgType: organization.orgType || 'org',
        orgDesc: organization.orgDesc || organization.description || '',
        displayOrder: organization.displayOrder || 0,
        isValid: organization.isValid === '1' || organization.isValid === 1
      }}
