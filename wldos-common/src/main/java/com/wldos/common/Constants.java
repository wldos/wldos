...
public final class Constants {
	...
	/** 默认域ID */
	public static final long DEFAULT_DOMAIN_ID = 0L;
	...
	public static final String CONTEXT_KEY_TOKEN_REFRESH = "refresh";
	...
	public static final String WLDOS_VERSION = "2.3.8.0";
	
	/** WLDOS 版本号（带 V 前缀，用于显示） */
	public static final String WLDOS_VERSION_DISPLAY = "V2.3.8.0";
	
	/** WLDOS 版本号（小写 v 前缀，用于 banner 等） */
	public static final String WLDOS_VERSION_LOWER = "v2.3.8.0";
}