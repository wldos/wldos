...
public final class Constants {
	...
	public static final String WLDOS_VERSION = "2.3.7.1";
	
	/** WLDOS 版本号（带 V 前缀，用于显示） */
	public static final String WLDOS_VERSION_DISPLAY = "V2.3.7.1";
	
	/** WLDOS 版本号（小写 v 前缀，用于 banner 等） */
	public static final String WLDOS_VERSION_LOWER = "v2.3.7.1";
}