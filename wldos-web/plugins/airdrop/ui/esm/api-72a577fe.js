...
var decode$1 = function (str, defaultDecoder, charset) {
...
function fetchMiddleware(ctx, next) {
  ...
  if (__umiRequestCoreType__ !== 'normal') {
    if (process && process.env && "production" === 'development' && warnedCoreType === false) {
      warnedCoreType = true;
...
var apiCall = function apiCall(url) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return request("".concat(API_BASE).concat(url), options);
};
...
var taskAPI = {
  ...
  updateTask: function updateTask(id, task) {
    return apiCall("/tasks/".concat(id), {
      method: 'PUT',
      data: task
    });
  },
  ...
  // 执行任务
  executeTask: function executeTask(id) {
    return apiCall("/tasks/".concat(id, "/execute"), {
      method: 'POST'
    });
  }
};
...
var templateAPI = {
  ...
  // 更新模板
  updateTemplate: function updateTemplate(id, template) {
    return apiCall("/templates/".concat(id), {
      method: 'PUT',
      data: template
    });
  },
...
var executionAPI = {
  ...
  getExecutions: function getExecutions() {
    return apiCall('/execution');
  },
  // 获取执行详情
  getExecutionDetail: function getExecutionDetail(id) {
    return apiCall("/execution/".concat(id));
  }
};
...
var queueAPI = {
  ...
  getQueues: function getQueues() {
    return apiCall('/queues');
  },
  // 获取队列状态
  getQueueStatus: function getQueueStatus(name) {
    return apiCall("/queues/".concat(name, "/status"));
  },
  // 更新队列配置
  updateQueue: function updateQueue(name, config) {
    return apiCall("/queues/".concat(name), {
      method: 'PUT',
      data: config
    });
  }
...
var schedulerAPI = {
  // 创建调度任务
  createScheduledTask: function createScheduledTask(config) {
    return apiCall('/scheduler/tasks', {
      method: 'POST',
      data: config
    });
  },
  // 执行调度任务
  executeScheduledTask: function executeScheduledTask(taskId) {
    return apiCall("/scheduler/tasks/".concat(taskId, "/execute"), {
      method: 'POST'
    });
  },
  // 获取调度任务列表
  getScheduledTasks: function getScheduledTasks() {
    return apiCall('/scheduler/tasks');
  },
  // 删除调度任务
  deleteScheduledTask: function deleteScheduledTask(taskId) {
    return apiCall("/scheduler/tasks/".concat(taskId), {
      method: 'DELETE'
    });
  }
};
...
var configAPI = {
  ...
  // 获取比特浏览器配置
  getBitBrowserConfig: function getBitBrowserConfig() {
    return apiCall('/configs/bitbrowser');
  }
};
...
var i18nAPI = {
  ...
  getMessage: function getMessage(key) {
    ...
    return apiCall("/i18n/message?key=".concat(key, "&locale=").concat(locale));
  },
  // 获取支持的语言列表
  getLocales: function getLocales() {
    return apiCall('/i18n/locales');
  }
};
...
var cronAPI = {
  // 获取所有Cron任务
  getCronTasks: function getCronTasks() {
    return apiCall('/cron/tasks');
  },
  // 创建Cron任务
  createCronTask: function createCronTask(taskId, cronExpression) {
    return apiCall('/cron/tasks', {
      method: 'POST',
      data: {
        taskId: taskId,
  ...
  // 暂停Cron任务
  pauseCronTask: function pauseCronTask(cronTaskId) {
    return apiCall("/cron/tasks/".concat(cronTaskId, "/pause"), {
      method: 'PUT'
    });
  },
  // 恢复Cron任务
  resumeCronTask: function resumeCronTask(cronTaskId) {
    return apiCall("/cron/tasks/".concat(cronTaskId, "/resume"), {
      method: 'PUT'
    });
  },
  // 删除Cron任务
  deleteCronTask: function deleteCronTask(cronTaskId) {
    return apiCall("/cron/tasks/".concat(cronTaskId), {
      method: 'DELETE'
    });
  },
  // 更新Cron表达式
  updateCronExpression: function updateCronExpression(cronTaskId, cronExpression) {
    return apiCall("/cron/tasks/".concat(cronTaskId, "/update-cron"), {
      method: 'PUT',
      data: {
        cronExpression: cronExpression
      }
...
var dependencyAPI = {
  // 添加依赖
  addDependency: function addDependency(taskId, dependentTaskId) {
  ...
  // 移除依赖
  removeDependency: function removeDependency(taskId, dependentTaskId) {
    return apiCall('/dependencies', {
      method: 'DELETE',
      data: {
        taskId: taskId,
  ...
  // 获取任务依赖
  getDependencies: function getDependencies(taskId) {
    return apiCall("/dependencies/".concat(taskId));
  },
  // 检查循环依赖
  checkCycle: function checkCycle(taskId, dependentTaskId) {
    return apiCall('/dependencies/check-cycle', {
      method: 'POST',
      data: {
        taskId: taskId,
        dependentTaskId: dependentTaskId
  ...
  // 获取依赖图
  getDependencyGraph: function getDependencyGraph() {
    return apiCall('/dependencies/graph');
  }
};
...
var debugAPI = {
  // 创建调试会话
  createDebugSession: function createDebugSession(taskId, script, scriptType) {
    return apiCall('/debug/sessions', {
      method: 'POST',
      data: {
        taskId: taskId,
        script: script,
  ...
  // 获取调试会话信息
  getDebugSession: function getDebugSession(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId));
  },
  // 开始调试
  startDebug: function startDebug(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/start"), {
      method: 'POST'
    });
  },
  // 停止调试
  stopDebug: function stopDebug(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/stop"), {
      method: 'POST'
    });
  },
  // 继续执行
  continueExecution: function continueExecution(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/continue"), {
      method: 'POST'
    });
  },
  // 单步执行
  stepOver: function stepOver(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/step-over"), {
      method: 'POST'
    });
  },
  // 单步进入
  stepInto: function stepInto(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/step-into"), {
      method: 'POST'
    });
  },
  // 单步跳出
  stepOut: function stepOut(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/step-out"), {
      method: 'POST'
    });
  },
  // 暂停执行
  pauseExecution: function pauseExecution(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/pause"), {
      method: 'POST'
    });
  },
  // 获取断点列表
  getBreakpoints: function getBreakpoints(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/breakpoints"));
  },
  // 设置断点
  setBreakpoint: function setBreakpoint(sessionId, lineNumber, condition) {
    return apiCall("/debug/sessions/".concat(sessionId, "/breakpoints"), {
      method: 'POST',
      data: {
  ...
  // 移除断点
  removeBreakpoint: function removeBreakpoint(sessionId, lineNumber) {
    return apiCall("/debug/sessions/".concat(sessionId, "/breakpoints/").concat(lineNumber), {
      method: 'DELETE'
    });
  },
  // 获取变量
  getVariables: function getVariables(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/variables"));
  },
  // 设置变量
  setVariable: function setVariable(sessionId, variableName, value) {
    return apiCall("/debug/sessions/".concat(sessionId, "/variables/").concat(variableName), {
      method: 'PUT',
      data: {
        value: value
      }
  ...
  // 获取调用栈
  getCallStack: function getCallStack(sessionId) {
    return apiCall("/debug/sessions/".concat(sessionId, "/call-stack"));
  }
};
...
var progressAPI = {
  // 获取任务进度
  getTaskProgress: function getTaskProgress(taskId) {
    return apiCall("/tasks/".concat(taskId, "/progress"));
  },
  // 获取所有任务进度
  getAllProgress: function getAllProgress() {
    return apiCall('/tasks/progress');
  }
};
...
var batchAPI = {
  // 批量创建任务
  batchCreate: function batchCreate(tasks) {
    return apiCall('/tasks/batch/create', {
      method: 'POST',
      data: {
        tasks: tasks
      }
  ...
  // 批量更新任务
  batchUpdate: function batchUpdate(tasks) {
    return apiCall('/tasks/batch/update', {
      method: 'PUT',
      data: {
        tasks: tasks
      }
  ...
  // 批量删除任务
  batchDelete: function batchDelete(taskIds) {
  ...
  // 批量执行任务
  batchExecute: function batchExecute(taskIds) {
    return apiCall('/tasks/batch/execute', {
      method: 'POST',
      data: {
        taskIds: taskIds
      }
  ...
  // 批量停止任务
  batchStop: function batchStop(taskIds) {
    return apiCall('/tasks/batch/stop', {
      method: 'POST',
      data: {
        taskIds: taskIds
      }
...
var searchAPI = {
  // 搜索任务
  searchTasks: function searchTasks(criteria) {
  ...
  getFilterCriteria: function getFilterCriteria() {
    return apiCall('/tasks/filters/criteria');
  },
  // 保存筛选条件
  saveFilter: function saveFilter(userId, filterName, criteria) {
    return apiCall('/tasks/filters/save', {
      method: 'POST',
      data: {
        userId: userId,
  ...
  // 加载筛选条件
  loadFilter: function loadFilter(userId, filterName) {
    return apiCall("/tasks/filters/load?userId=".concat(userId, "&filterName=").concat(filterName));
  },
  // 删除筛选条件
  deleteFilter: function deleteFilter(userId, filterName) {
    return apiCall('/tasks/filters/delete', {
      method: 'DELETE',
      data: {
        userId: userId,
        filterName: filterName
...
var exportAPI = {
  ...
  exportTasks: function exportTasks() {
    ...
    return apiCall("/export/tasks?format=".concat(format), {
      method: 'GET',
      responseType: 'blob'
    });
  },
  // 导出执行记录
  exportExecutionRecords: function exportExecutionRecords() {
    var format = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'csv';
    return apiCall("/export/execution-records?format=".concat(format), {
      method: 'GET',
      responseType: 'blob'
    });
  },
  ...
  exportStatistics: function exportStatistics() {
    var format = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'csv';
    return apiCall("/export/statistics?format=".concat(format), {
      method: 'GET',
      responseType: 'blob'
    });
  }
...
var notificationAPI = {
  // 配置通知规则
  configureNotification: function configureNotification(taskId, rule) {
    return apiCall("/tasks/".concat(taskId, "/notification/rule"), {
      method: 'POST',
      data: rule
    });
  },
  // 获取通知规则
  getNotificationRule: function getNotificationRule(taskId) {
    return apiCall("/tasks/".concat(taskId, "/notification/rule"));
  },
  // 获取通知历史
  getNotificationHistory: function getNotificationHistory(taskId) {
    var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
    return apiCall("/tasks/".concat(taskId, "/notification/history?limit=").concat(limit));
  },
  // 发送测试邮件
  sendTestEmail: function sendTestEmail(taskId, recipients) {
    return apiCall("/tasks/".concat(taskId, "/notification/send-test"), {
      method: 'POST',
      data: {
...
var statisticsAPI = {
  // 获取总体统计
  getOverallStatistics: function getOverallStatistics() {
    return apiCall('/statistics');
  },
  // 获取图表数据
  getChartData: function getChartData(chartType, timeRange) {
    return apiCall('/statistics/charts', {
      method: 'POST',
      data: {
        chartType: chartType,
        timeRange: timeRange
...
var versionAPI = {
  // 获取任务版本列表
  getVersions: function getVersions(taskId) {
    return apiCall("/tasks/".concat(taskId, "/versions"));
  },
  // 创建新版本
  createVersion: function createVersion(taskId, versionNumber, description, scriptContent, author) {
    return apiCall("/tasks/".concat(taskId, "/versions"), {
      method: 'POST',
      data: {
  ...
  // 获取当前版本
  getCurrentVersion: function getCurrentVersion(taskId) {
    return apiCall("/tasks/".concat(taskId, "/versions/current"));
  },
  // 获取版本详情
  getVersion: function getVersion(taskId, versionNumber) {
    return apiCall("/tasks/".concat(taskId, "/versions/").concat(versionNumber));
  },
  // 版本回滚
  rollbackVersion: function rollbackVersion(taskId, versionNumber) {
    return apiCall("/tasks/".concat(taskId, "/versions/").concat(versionNumber, "/rollback"), {
      method: 'POST'
    });
  },
  // 版本对比
  compareVersions: function compareVersions(taskId, version1, version2) {
    return apiCall("/tasks/".concat(taskId, "/versions/compare?version1=").concat(version1, "&version2=").concat(version2));
  }
};
...
var testAPI = {
  // 创建测试用例
  createTestCase: function createTestCase(testCase) {
  ...
  // 获取测试用例
  getTestCase: function getTestCase(testId) {
    return apiCall("/tests/".concat(testId));
  },
  // 执行测试用例
  executeTestCase: function executeTestCase(testId) {
    return apiCall("/tests/".concat(testId, "/execute"), {
      method: 'POST'
    });
  },
  // 获取测试结果
  getTestResult: function getTestResult(testId) {
    return apiCall("/tests/".concat(testId, "/result"));
  },
  // 批量执行测试
  executeBatch: function executeBatch(testCaseIds) {
    return apiCall('/tests/batch/execute', {
      method: 'POST',
      data: {
        testIds: testCaseIds
      }
  ...
  // 生成测试报告
  generateTestReport: function generateTestReport(testIds) {
    return apiCall('/tests/report', {
      method: 'POST',
      data: {
        testIds: testIds
      }
  ...
  // 获取测试用例列表（兼容旧接口，需要根据taskId过滤）
  getTestCases: function getTestCases(taskId) {
    return apiCall("/tests?taskId=".concat(taskId));
  },
  // 获取测试报告（兼容旧接口）
  getTestReports: function getTestReports(taskId) {
    return apiCall("/tests/report?taskId=".concat(taskId));
  }
};
...
var performanceAPI = {
  // 记录性能指标
  recordMetrics: function recordMetrics(taskId, metrics) {
    return apiCall("/performance/".concat(taskId, "/metrics"), {
      method: 'POST',
      data: metrics
    });
  },
  // 分析性能
  analyzePerformance: function analyzePerformance(taskId) {
    return apiCall("/performance/".concat(taskId, "/analyze"));
  },
  // 获取性能报告
  getPerformanceReport: function getPerformanceReport(taskId) {
    return apiCall("/performance/".concat(taskId, "/report"));
  }
};
...
var collaborationAPI = {
  // 创建协作会话
  createSession: function createSession(taskId, userId, userName) {
    return apiCall("/collaboration/".concat(taskId, "/session"), {
      method: 'POST',
      data: {
        userId: userId,
        userName: userName
  ...
  // 加入协作会话
  joinSession: function joinSession(taskId, userId, userName) {
    return apiCall("/collaboration/".concat(taskId, "/join"), {
      method: 'POST',
      data: {
        userId: userId,
        userName: userName
  ...
  // 离开协作会话
  leaveSession: function leaveSession(taskId, userId) {
    return apiCall("/collaboration/".concat(taskId, "/leave"), {
      method: 'POST',
      data: {
        userId: userId
      }
  ...
  // 获取协作内容
  getContent: function getContent(taskId) {
    return apiCall("/collaboration/".concat(taskId, "/content"));
  },
  // 应用操作
  applyOperation: function applyOperation(taskId, operation) {
    return apiCall("/collaboration/".concat(taskId, "/operation"), {
      method: 'POST',
      data: operation
    });
  },
  // 锁定行
  lockLine: function lockLine(taskId, userId, lineNumber) {
    return apiCall("/collaboration/".concat(taskId, "/lock"), {
      method: 'POST',
      data: {
        userId: userId,
        lineNumber: lineNumber
  ...
  // 解锁行
  unlockLine: function unlockLine(taskId, userId, lineNumber) {
    return apiCall("/collaboration/".concat(taskId, "/unlock"), {
      method: 'POST',
      data: {
        userId: userId,
        lineNumber: lineNumber
  ...
  // 获取协作历史
  getHistory: function getHistory(taskId) {
    return apiCall("/collaboration/".concat(taskId, "/history"));
  }
};
...
var marketAPI = {
  ...
  getTemplates: function getTemplates(params) {
    return apiCall('/market/templates/search', {
      method: 'GET',
      params: {
        keyword: params === null || params === void 0 ? void 0 : params.keyword,
        category: params === null || params === void 0 ? void 0 : params.category,
        sortBy: (params === null || params === void 0 ? void 0 : params.sortBy) || 'downloadCount'
      }
    });
  },
  // 获取模板详情
  getTemplate: function getTemplate(templateId) {
    return apiCall("/market/templates/".concat(templateId));
  },
  // 上传模板
  uploadTemplate: function uploadTemplate(template) {
    return apiCall('/market/templates', {
      method: 'POST',
      data: template
    });
  },
  ...
  downloadTemplate: function downloadTemplate(templateId) {
    return apiCall("/market/templates/".concat(templateId, "/download"), {
      method: 'POST'
    });
  },
  // 评分模板
  rateTemplate: function rateTemplate(templateId, userId, rating, comment) {
    return apiCall("/market/templates/".concat(templateId, "/rate"), {
      method: 'POST',
      data: {
        userId: userId,
        score: rating,
  ...
  getCategories: function getCategories() {
    return apiCall('/market/categories');
  }
};
...
var visualizationAPI = {
  // 解析并可视化结果
  parseResult: function parseResult(result, resultType) {
    return apiCall('/visualization/parse', {
      method: 'POST',
      data: {
        result: result,
...
// 自动更新API（扩展）
_objectSpread2$1(_objectSpread2$1({}, updateAPI), {}, {
  // 获取更新备份
  getUpdateBackups: function getUpdateBackups() {
    return apiCall('/update/backups');
  },
  // 回滚更新
  rollbackUpdate: function rollbackUpdate(type, name) {
    return apiCall('/update/rollback', {
      method: 'POST',
      data: {
        type: type,
        name: name
...
export { _createForOfIteratorHelper as A, dependencyAPI as B, debugAPI as C, notificationAPI as D, statisticsAPI as E, versionAPI as F, testAPI as G, performanceAPI as H, collaborationAPI as I, marketAPI as J, getDefaultExportFromCjs as K, _slicedToArray as _, _asyncToGenerator as a, _regenerator as b, commonjsGlobal as c, searchAPI as d, batchAPI as e, exportAPI as f, templateAPI as g, _createClass$1 as h, _objectWithoutProperties as i, _objectSpread2$1 as j, _classCallCheck$1 as k, _typeof$1 as l, _defineProperty$1 as m, _toConsumableArray$1 as n, executionAPI as o, progressAPI as p, queueAPI as q, configAPI as r, schedulerAPI as s, taskAPI as t, updateAPI as u, visualizationAPI as v, permissionAPI as w, i18nAPI as x, cronAPI as y, _regeneratorValues as z };
