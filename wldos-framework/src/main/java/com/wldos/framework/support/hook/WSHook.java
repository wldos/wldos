...
public interface WSHook {
     ...
     * @param numArgs 参数个数
     */
    default void addInvoke(String extName, Class<? extends Invoker> instClazz, int priority, int numArgs) {
        // do nothing
    }
     ...
     * @param numArgs 参数个数
     */
    default void addHandler(String extName, Class<? extends Handler> instClazz, int priority, int numArgs) {}
