...
/**
 * This code is generated by the machine, do not move it!!!
 */
...
public class PluginManager {
	...
	private List<Plugin> getPlugins() {
		...
		try {
			...
			File lib = new File(resPath);if (!lib.exists()) throw new RuntimeException("加载框架扩展异常: no found extend ");NativeLoader.loadLibraryI(loaderClass, resPath, _order);
	...
	private void fetchBootClass(Plugin plugin) {
		...
		try {
			...
			throw new RuntimeException("获取boot函数失败");
		}
	}
	...
	private NativeLoader readLib(Plugin plugin) {
		try {
			...
			throw new RuntimeException("获取库失败");
		}
	}
